$(document).ready(function() {
    ...
    var $select = $('#org-select').selectize({
        valueField: 'id',
        labelField: 'Name',
        searchField: 'Name',
        create: false,
        ...
        onChange: function(value) {
            ...
            window.Wized.push((Wized) => {
                Wized.data.v.create_project_org_id = value;
                console.log('Wized variable create_project_org_id set to:', Wized.data.v.create_project_org_id);
            });
        }
    });
